...
Arterial Day-to-Day is an internal team operations tracker that replaces spreadsheets and chat with a shared dashboard for logging work, tracking records, and monitoring statuses in real time.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "293350223+edmundcheongkc@users.noreply.github.com"
  git config user.name "edmundcheongkc"
  ```

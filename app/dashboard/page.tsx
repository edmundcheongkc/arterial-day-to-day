...
export default async function DashboardPage({
  ...
  const [records, teamMembers, activities, lastActivityMap, titleMap] = await Promise.all([
  ...
  return (
    <main className="min-h-screen p-6 md:p-10 max-w-6xl mx-auto">
      ...
      <header className="flex items-center justify-between mb-8">
        ...
        <NewWorkRecordForm teamMembers={teamMembers} />
      </header>

      <FilterBar teamMembers={teamMembers} />

      <div className="grid gap-6 lg:grid-cols-[1fr_260px]">
        <KanbanBoard records={records} teamMembers={teamMembers} lastActivityMap={lastActivityMap} />
